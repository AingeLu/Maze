...
namespace PureMVC.Core
{
    ...
    public class Controller: IController
    {
        ...
        {
            Func<ICommand> _commandFunc = null;
            if (commandMap.TryGetValue(notificationName, out _commandFunc) == false)
            {
        ...
        {
            Func<ICommand> commandFunc = null;
            if (commandMap.TryGetValue(notificationName, out commandFunc))
            {
